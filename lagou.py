...
def request_info(url):
  ...
  companies = soup.select('#s_position_list > ul > li > div.list_item_top > div.company > div.company_name > a')
  # print('公司', companies, '数量', len(companies))
  salaries = soup.select('#s_position_list > ul > li > div.list_item_top > div.position > div.p_bot > div > span')
  # print('工资', salaries, '数量', len(salaries))
  experiences = soup.select('#s_position_list > ul > li > div.list_item_top > div.position > div.p_bot')
...
def request_main(root_url):
  url = 'https://www.lagou.com/zhaopin/Python/{}/?filterOption=2'
...
def main():
  request_main('https://www.lagou.com/zhaopin/Python/1/?filterOption=2')
